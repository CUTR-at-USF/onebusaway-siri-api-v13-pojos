...
public class MonitoredCall {
	...
	protected FacilityChange facilityChange;
	...
	public void setFacilityCondition(List<FacilityCondition> facilityCondition) {
	 ...
	 * <CODE>set</CODE> method for the callNote property.
	 * 
	 * <p>
	...
	/**
	 * Information about a change of Equipment availabiltiy at stop that may
	 * affect access or use.Gets the value of the facilityCondition
	 * property.
	 * 
	 * <p>
	 * This accessor method returns a reference to the live list, not a
	 * snapshot. Therefore any modification you make to the returned list will
	 * be present inside the JAXB object. This is why there is not a
	 * <CODE>set</CODE> method for the facilityCondition property.
	 * 
	 * <p>
	 * For example, to add a new item, do as follows:
	 * 
	 ...
	 * 
	 * @return possible object is {@link FacilityChange }
	 * 
	 */
	
	public FacilityChange getFacilityChange() {
	 ...
	 * 
	 * @param value
	 *            allowed object is {@link FacilityChange }
	 * 
	 */
	
	public void setFacilityChange(FacilityChange value) {
	 ...
	 * snapshot. Therefore any modification you make to the returned list will
	 * be present inside the JAXB object. This is why there is not a
	 * <CODE>set</CODE> method for the situationRef property.
	 * 
	 * <p>
	 * For example, to add a new item, do as follows:
	 * 
